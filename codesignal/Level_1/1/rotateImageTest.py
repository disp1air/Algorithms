...
class RotateImageTestCase(unittest.TestCase):
    def test_rotate_image(self):
        ...
        outputList = [[7,4,1], [8,5,2], [9,6,3]]
        result = RotateImage(inputList)
        ...
        inputList = [[10,9,6,3,7],
                     [6,10,2,9,7], 
                     [7,6,3,8,2], 
                     [8,9,7,9,9], 
                     [6,8,6,8,2]]
        outputList = [[6,8,7,6,10], 
                      [8,9,6,10,9], 
                      [6,7,3,2,6], 
                      [8,9,8,9,3], 
                      [2,9,2,7,7]]
        ...
        inputList = [[40,12,15,37,33,11,45,13,25,3], 
        ...
        outputList = [[8,38,12,31,14,45,48,44,37,40], 
        ...
        inputList = [[33,35,8,24,19,1,3,1,4,5], 
        ...
        outputList = [[18,33,45,8,37,40,30,9,25,33], 
